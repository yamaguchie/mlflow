...
from mlflow.tracking._default_experiment.databricks_notebook_context import DatabricksNotebookExperimentContext
from mlflow.tracking._default_experiment.databricks_job_context import DatabricksJobExperimentContext
...
class DefaultExperimentProviderRegistry(object):
    ...
    This class allows the registration of a default experiment provider which can be used to infer meta
    information about the context of an MLflow experiment. Implementations declared though the
    entrypoints `mlflow.default_experiment_provider` group can be automatically registered through the
    ...
    def register_entrypoints(self):
        ...
        for entrypoint in entrypoints.get_group_all("mlflow.default_experiment_provider"):
            try:
                ...
                warnings.warn(
                    'Failure attempting to register default experiment context provider "{}": {}'.format(
